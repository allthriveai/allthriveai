...
def example_with_system_message():
    ...
    response = ai.complete(prompt=prompt, system_message=system_message, temperature=0.3, max_tokens=200)
...
def example_custom_model():
    ...
    try:
        ...
        response = ai.complete(
            prompt=prompt, model="gpt-4", temperature=0.5  # Replace with your actual deployment name
        )
