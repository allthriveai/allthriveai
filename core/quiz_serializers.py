...
class QuizQuestionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = QuizQuestion
        fields = [
            'id', 'quiz_id', 'question', 'type', 'correct_answer',
            'options', 'explanation', 'hint', 'order', 'image_url'
        ]
        read_only_fields = ['id']
...
class QuizSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Quiz
        fields = [
            'id', 'title', 'slug', 'description', 'topic', 'difficulty',
            'estimated_time', 'question_count', 'thumbnail_url',
            'is_published', 'created_at', 'updated_at', 'created_by',
            'user_has_attempted', 'user_best_score', 'user_attempt_count'
        ]
...
class QuizAttemptSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = QuizAttempt
        fields = [
            'id', 'quiz', 'user', 'answers', 'score', 'total_questions',
            'percentage_score', 'is_completed', 'started_at', 'completed_at'
        ]
