...
from .quiz_throttles import QuizStartThrottle, QuizAnswerThrottle
...
class QuizAttemptViewSet(viewsets.GenericViewSet):
    ...
    def answer(self, request, pk=None):
        ...
        try:
            ...
            return Response(
                {'error': 'Quiz attempt not found or does not belong to you'},
    ...
    def quiz_stats(self, request):
        ...
        for topic_dict in topics:
            ...
            topic_avg = topic_attempts.aggregate(
                avg_score=Avg('score'),
                avg_total=Avg('total_questions')
            )
