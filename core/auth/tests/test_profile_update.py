...
class ProfileUpdateTestCase(TestCase):
    ...
    def test_update_username_success(self):
        ...
        response = self.client.patch("/api/v1/me/profile/", {"username": "newusername"}, format="json")
    ...
    def test_update_username_to_existing_fails(self):
        ...
        response = self.client.patch("/api/v1/me/profile/", {"username": "existinguser"}, format="json")
    ...
    def test_update_username_too_short_fails(self):
        ...
        response = self.client.patch("/api/v1/me/profile/", {"username": "ab"}, format="json")
    ...
    def test_update_username_invalid_characters_fails(self):
        ...
        response = self.client.patch("/api/v1/me/profile/", {"username": "test user"}, format="json")
    ...
    def test_update_other_profile_fields(self):
        ...
        response = self.client.patch(
            "/api/v1/me/profile/", {"first_name": "Updated", "last_name": "Name", "bio": "Updated bio"}, format="json"
        )
    ...
    def test_update_username_and_other_fields_together(self):
        ...
        response = self.client.patch(
            "/api/v1/me/profile/", {"username": "updateduser", "first_name": "Updated", "bio": "New bio"}, format="json"
        )
    ...
    def test_username_unchanged_when_same(self):
        ...
        response = self.client.patch(
            "/api/v1/me/profile/", {"username": "testuser"}, format="json"  # Same as current username
        )
