...
from core.role_models import RolePermission
    ...
    def handle(self, *args, **options):
        roles_data = [
            ...
            },
            {
                ...
                'display_name': 'Expert',
                'description': 'Experienced members who contribute quality content. Increased project limits and AI usage.',
                'badge_color': 'blue',
                'hierarchy_level': 2,
                'can_create_projects': True,
                'max_projects': 25,
            ...
            },
            {
                ...
                'display_name': 'Mentor',
                'description': 'Trusted community members who guide and support others. Can mentor users and access exclusive features.',
                'badge_color': 'purple',
                'hierarchy_level': 3,
                'can_create_projects': True,
                'max_projects': 50,
            ...
            },
            {
                ...
                'display_name': 'Patron',
                'description': 'Premium supporters of the platform. Unlimited projects, priority support, and premium features.',
                'badge_color': 'amber',
                'hierarchy_level': 4,
                'can_create_projects': True,
        ...
        for role_data in roles_data:
            ...
            if created:
                self.stdout.write(
                    self.style.SUCCESS(f'Created role permissions for: {role_data["display_name"]}')
                )
            else:
                self.stdout.write(
                    self.style.SUCCESS(f'Updated role permissions for: {role_data["display_name"]}')
                )
