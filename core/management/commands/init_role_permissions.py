    ...
    def handle(self, *args, **options):
        roles_data = [
            ...
            },
            {
                ...
                'description': 'Active learners growing their skills. Increased AI usage and project limits.',
                'badge_color': 'teal',
                'hierarchy_level': 2,
                'can_create_projects': True,
                'max_projects': 15,
            ...
            },
            {
                ...
                'description': (
                    'Content creators who build and showcase projects. Enhanced showcase and AI capabilities.'
                ),
                'badge_color': 'green',
                'hierarchy_level': 4,
                'can_create_projects': True,
