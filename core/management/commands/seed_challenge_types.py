...
CHALLENGE_TYPES = [
    {
        ...
        'variables': {
            'element': [
                'sentient jello',
                'giant houseplants',
                'vintage furniture that watches you',
                'mismatched socks',
                'passive-aggressive sticky notes',
                'vending machines with opinions',
            ],
            ...
            'concept': [
                ...
                'cats run the government',
                'all buildings are bouncy castles',
            ],
            'weird_rule': [
                'everyone must wear capes',
                'all furniture floats three feet off the ground',
                'trees gossip about tourists',
                'pets walk their humans',
            ],
        },
        'judging_criteria': [
    ...
    },
    {
        ...
        'variables': {
            'weird_habitat': [
                'the back of an old refrigerator',
                'a junk drawer full of batteries and rubber bands',
                'the space between couch cushions',
                'an abandoned shopping cart in a parking lot',
                'a pile of tangled Christmas lights',
            ],
            'survival_method': [
                'eating lost socks',
                'hoarding expired coupons',
                'collecting dust bunnies',
                'stealing crumbs from keyboards',
            ],
            'relatable_crime': [
                'leave one bite of food in the container',
                'put empty cartons back in the fridge',
                'microwave fish in the office',
                'steal pens from work',
            ],
            'animal1': ['corgi', 'axolotl', 'capybara', 'red panda', 'blobfish'],
            'unexpected_thing': [
                'a cozy knit sweater',
                'a cactus wearing sunglasses',
                'a melting popsicle',
                'a deflated balloon animal',
    ...
    },
    {
        ...
        'variables': {
            ...
            'purpose': [
                ...
                'people who only wear pajamas',
                'professional cloud watchers',
            ],
            'problem': ['traffic', 'pigeons', 'running out of snacks', 'stepping on Legos'],
            'absurd_solution': [
                'teleporting cats',
    ...
    {
        'key': 'fake_product',
        'name': 'Fake Product Ads',
        'description': 'Create hilarious advertisements for products that should never exist.',
        'category_slug': 'images-video',
        'templates': [
            'Create an ad for "{product_name}" - a {product_type} for people who {target_audience}',
            'Design the infomercial screenshot for a product that solves {fake_problem}',
            'Make a luxury ad for the premium version of {mundane_item}',
        ],
        'variables': {
            'product_name': [
                'The Procrastinator 3000',
                'Passive Aggressive Post-Its',
                'Couples Therapy in a Can',
                'Instant Personality',
                'Confidence Spray',
            ...
            'target_audience': [
                ...
                'reply-all by accident regularly',
                'have strong opinions about fonts',
                'cry at commercials',
                'ghosted their gym membership',
            ],
            'fake_problem': [
                'opening a bag of chips quietly during a meeting',
                "accidentally waving back at someone who wasn't waving at you",
                'pretending to work while your boss walks by',
                "forgetting someone's name 0.2 seconds after they tell you",
                'running into someone you know at the grocery store',
            ],
            'mundane_item': [
        ...
        'judging_criteria': [
            {'name': 'Ad Believability', 'weight': 30, 'description': 'Does it look like a real ad?'},
            {'name': 'Humor', 'weight': 30, 'description': 'How funny is the concept?'},
            {'name': 'Product Clarity', 'weight': 20, 'description': 'Is the product concept clear?'},
            {'name': 'Visual Quality', 'weight': 20, 'description': 'Is it well-designed?'},
        ],
        'default_duration_minutes': 4,
        'winner_points': 50,
        'participation_points': 10,
    ...
    },
    {
        ...
        'variables': {
            ...
            'realization': [
                ...
                "that wasn't sugar they just ate",
                "there's a spider on their shoulder",
                'they stepped in something wet wearing socks',
    ...
    },
    {
        ...
        'variables': {
            ...
            'relatable_moment': [
                'checking the fridge for the 5th time hoping new food appeared',
                'pretending to text while walking past someone you know',
                'waving back at someone who was waving at someone else',
                'sitting back down after standing up and forgetting why',
            ...
            'subject': [
                ...
                'a seagull stealing fries',
            ],
            'discovery': [
                'there are no more snacks',
                'the milk is expired',
                'the pizza box is empty',
                'how expensive avocados are',
            ],
        },
        'judging_criteria': [
