...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        taxonomies_data = [
            # Interests
            {'name': 'AI & Machine Learning', 'category': 'interest', 'description': 'Artificial intelligence, machine learning, and deep learning'},
            {'name': 'Web Development', 'category': 'interest', 'description': 'Frontend, backend, and full-stack web development'},
            {'name': 'Data Science', 'category': 'interest', 'description': 'Data analysis, visualization, and statistical modeling'},
            {'name': 'Design', 'category': 'interest', 'description': 'UI/UX design, graphic design, and product design'},
            {'name': 'Creative Writing', 'category': 'interest', 'description': 'Writing, storytelling, and content creation'},
            {'name': 'Photography', 'category': 'interest', 'description': 'Photography, photo editing, and visual arts'},
            ...
            {'name': 'Project Management', 'category': 'skill', 'description': 'Planning, organizing, and managing projects'},
            
            # Goals
            {'name': 'Build a Portfolio', 'category': 'goal', 'description': 'Create and showcase professional work'},
            {'name': 'Learn New Skills', 'category': 'goal', 'description': 'Acquire new technical or creative abilities'},
            ...
            # Topics
            {'name': 'Prompt Engineering', 'category': 'topic', 'description': 'Crafting effective prompts for AI agents'},
            ...
            # AI Tools
            {'name': 'ChatGPT', 'category': 'tool', 'description': 'OpenAI conversational AI chatbot for text generation and assistance'},
            {'name': 'Claude', 'category': 'tool', 'description': 'Anthropic AI assistant for analysis, writing, and coding'},
            {'name': 'Midjourney', 'category': 'tool', 'description': 'AI image generation tool for creating digital artwork'},
            ...
            {'name': 'GitHub Copilot', 'category': 'tool', 'description': 'AI pair programmer for code completion and suggestions'},
            {'name': 'Cursor', 'category': 'tool', 'description': 'AI-powered code editor built for pair programming with AI'},
            ...
            {'name': 'Grammarly', 'category': 'tool', 'description': 'AI writing assistant for grammar and style checking'},
            {'name': 'Synthesia', 'category': 'tool', 'description': 'AI video generation platform with AI avatars'},
            {'name': 'Descript', 'category': 'tool', 'description': 'AI audio and video editing with text-based editing'},
            {'name': 'Hugging Face', 'category': 'tool', 'description': 'Platform for machine learning models and datasets'},
            {'name': 'Replicate', 'category': 'tool', 'description': 'Platform for running AI models in the cloud'},
            {'name': 'Anthropic Console', 'category': 'tool', 'description': 'Development platform for Claude API integration'},
            {'name': 'OpenAI Playground', 'category': 'tool', 'description': 'Interactive testing environment for OpenAI models'},
            {'name': 'LangChain', 'category': 'tool', 'description': 'Framework for developing LLM-powered applications'},
        ...
        for data in taxonomies_data:
            ...
            if created:
                created_count += 1
                self.stdout.write(
                    self.style.SUCCESS(f'Created taxonomy: {taxonomy.name}')
                )
            else:
                ...
                updated_count += 1
                self.stdout.write(
                    self.style.WARNING(f'Updated taxonomy: {taxonomy.name}')
                )
