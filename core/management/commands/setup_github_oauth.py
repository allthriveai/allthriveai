...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if not github_client_id or not github_client_secret:
            self.stdout.write(self.style.ERROR('GITHUB_CLIENT_ID and GITHUB_CLIENT_SECRET must be set in environment'))
            return
        ...
        self.stdout.write(f'\nCallback URL: {protocol}://{site.domain}/accounts/github/login/callback/')
