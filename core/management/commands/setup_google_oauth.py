...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if not google_client_id or not google_client_secret:
            self.stdout.write(self.style.ERROR('GOOGLE_CLIENT_ID and GOOGLE_CLIENT_SECRET must be set in environment'))
            return
        ...
        self.stdout.write(f'\nCallback URL: {protocol}://{site.domain}/accounts/google/login/callback/')
