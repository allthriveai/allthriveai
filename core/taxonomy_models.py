...
class UserTag(models.Model):
    ...
    confidence_score = models.FloatField(
        default=1.0,
        help_text="Confidence score for auto-generated tags (0.0-1.0)"
    )
    interaction_count = models.IntegerField(
        default=0,
        help_text="Number of interactions that generated this tag"
    )
    created_at = models.DateTimeField(auto_now_add=True)
...
class UserInteraction(models.Model):
    ...
    extracted_keywords = models.JSONField(
        default=list,
        blank=True,
        help_text="Keywords extracted from this interaction"
    )
    created_at = models.DateTimeField(auto_now_add=True)
