    ...
    <div className="min-h-screen bg-slate-900">
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="prose prose-invert prose-slate max-w-none space-y-8">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white mb-4">Community Standards</h2>
          ...
          <section>
            ...
            <p className="text-slate-300 leading-relaxed">
              <strong className="text-white">We reserve the right to suspend or terminate any account</strong> that
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white mb-4">Platform Security</h2>
            <p className="text-slate-300 leading-relaxed">
