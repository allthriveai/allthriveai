    ...
    return (
      <AnimatePresence>
        <motion.div
          ...
          className="bg-gradient-to-r from-orange-500/20 via-amber-500/20 to-red-500/20 border-b border-orange-500/30"
        >
          <div className="max-w-7xl mx-auto px-4 py-3">
            <div className="flex items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 flex items-center justify-center">
                  <FontAwesomeIcon icon={faDragon} className="text-2xl text-orange-500 drop-shadow-[0_0_8px_rgba(0,0,0,0.8)]" />
                </div>
              ...
              <div className="flex items-center gap-3">
                {onShowMoreRecommendations && (
                  <button
                    ...
                    className="px-3 py-1.5 rounded-lg bg-orange-500/20 hover:bg-orange-500/30 border border-orange-500/30 text-orange-300 text-sm font-medium transition-colors"
                  >
                    More things to do
                  </button>
                )}
    ...
    <AnimatePresence>
      {isExpanded && (
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          exit={{ opacity: 0, y: -20, height: 0 }}
          className="bg-gradient-to-r from-slate-800/80 via-slate-800/60 to-slate-800/80 border-b border-slate-700/50 backdrop-blur-sm"
        >
          <div className="max-w-7xl mx-auto px-4 py-3">
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-3 min-w-0">
                ...
                <span className="text-slate-300 text-sm hidden sm:block">
                  <span className="text-orange-400 font-medium">Ember:</span>{' '}
                  {completedCount === 0
              ...
              <div className="flex items-center gap-2">
                ...
                {completedAdventures.map((id) => {
                  ...
                  return (
                    <div
                      key={id}
                      className="flex items-center gap-1.5 px-2 py-1.5 rounded-lg bg-slate-700/50 text-slate-400 text-sm"
