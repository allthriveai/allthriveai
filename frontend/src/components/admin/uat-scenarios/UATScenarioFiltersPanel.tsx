 ...
 */
import type { UATCategory, UATScenarioAssignee, UATScenarioFilters, TestResult } from '@/types/uatScenarios';
...
export function UATScenarioFiltersPanel({
  ...
  const resultOptions: { value: TestResult | 'not_tested' | undefined; label: string; color: string }[] = [
    ...
    { value: 'not_tested', label: 'Not Tested', color: 'slate' },
  ];
