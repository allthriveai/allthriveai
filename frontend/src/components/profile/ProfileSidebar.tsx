      ...
      <div className="glass-subtle rounded-xl p-5 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="bg-gradient-to-br from-purple-500/10 to-pink-500/10 rounded-lg p-3 border border-purple-500/20">
            <div className="flex items-center gap-2 mb-1">
              <TrophyIcon className="w-4 h-4 text-purple-600 dark:text-purple-400" />
        ...
        <div className="glass-subtle rounded-xl p-5 space-y-4">
          ...
          <div className="space-y-2">
            {user.websiteUrl && (
              ...
              >
                <GlobeAltIcon className="w-5 h-5 text-gray-500 dark:text-gray-400 group-hover:text-gray-700 dark:group-hover:text-gray-300" />
