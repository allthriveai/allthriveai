 ...
 * OAuth-only signup (Google, GitHub, LinkedIn) - no email/password collection.
 */
...
export function GuestSignupModal({
  ...
  const handleOAuthLogin = async (provider: 'google' | 'github' | 'linkedin') => {
    ...
    try {
      // Prepare session for guest conversion
      await api.post('/me/account/prepare-guest-oauth/', {
        battle_id: battleId,
      });

      // Store backup state in localStorage in case session is lost
      if (battleId) {
        localStorage.setItem('guest_conversion_battle_id', String(battleId));
      }
      ...
      setError(error.response?.data?.error || 'Failed to start sign in. Please try again.');
          ...
          <div className="glass-card p-6 md:p-8">
            ...
            <div className="text-center mb-6">
              ...
              <p className="text-slate-400 text-sm">
                Sign in to save your battle results, earn XP, and challenge more opponents!
              </p>
            </div>
            ...
            <div className="bg-slate-800/50 rounded-xl p-4 mb-6">
              <ul className="space-y-2 text-sm">
                ...
                <li className="flex items-center gap-2 text-slate-300">
                  ...
                  <span>Track your wins and improve your prompt engineering</span>
                </li>
                <li className="flex items-center gap-2 text-slate-300">
            ...
            <div className="space-y-3 mb-6">
              <p className="text-xs text-slate-400 text-center">Continue with</p>
