      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-rose-500/20 border border-rose-500/30 mb-4">
            ...
            <span className="text-sm font-semibold text-rose-300 tracking-wider uppercase">
              Battle in Progress
            </span>
          </div>
        </motion.div>
        ...
        <div className="flex items-start justify-center gap-8 mb-12">
          ...
          >
            ...
            {/* Connection line */}
            <div className="w-px h-32 bg-gradient-to-b from-cyan-500/50 via-transparent to-pink-500/50 mt-4" />
          </motion.div>
        ...
        <motion.div
          ...
          className="mb-12"
        >
          <ChallengeDisplay challengeText={challengeText} challengeType={challengeType} />
        </motion.div>
