...
interface FigmaProjectPendingViewProps {
  project: Project;
}

export function FigmaProjectPendingView({ project }: FigmaProjectPendingViewProps) {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg p-8 shadow-lg border-2 border-dashed border-primary-300 dark:border-primary-700 mb-12">
        ...
        <p className="text-center text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
          We're analyzing this Figma design file to extract components, design system tokens, page structure,
          and create a comprehensive project overview. This usually takes 15-20 seconds.
        </p>
      </div>
