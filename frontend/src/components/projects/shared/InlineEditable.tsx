...
// ============================================================================
// EditModeIndicator - Shows when owner is viewing their project
// ============================================================================
...
export function EditModeIndicator({ isOwner }: EditModeIndicatorProps) {
  if (!isOwner) return null;

  return (
    <div className="fixed bottom-4 right-4 z-40 flex items-center gap-2 px-4 py-2 bg-primary-500 text-white text-sm font-medium rounded-full shadow-lg">
