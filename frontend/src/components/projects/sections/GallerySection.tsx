...
interface ImageThumbnailProps {
  ...
  preserveAspectRatio?: boolean; // For masonry layout
}
...
function ImageThumbnail({
  ...
  // When preserveAspectRatio is true (masonry layout), show images at their natural size
  if (preserveAspectRatio) {
    return (
      <button
        onClick={onClick}
        className="group relative overflow-hidden rounded-xl bg-gray-100 dark:bg-gray-800 hover:ring-2 hover:ring-primary-500 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-primary-500"
      >
        <img
          src={image.thumbnail || image.url}
          alt={image.alt || image.caption || 'Gallery image'}
