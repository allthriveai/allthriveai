      ...
      <div className="px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div aria-label="All Thrive" className="col-span-2 md:col-span-1">
            ...
            <ul className="space-y-3 mb-4">
              <li>
                <Link
                  to="/about"
                  className="text-gray-600 dark:text-gray-400 hover:text-emerald-600 dark:hover:text-cyan-400 transition-colors text-sm"
                >
                  About
                </Link>
              </li>
              ...
              <li>
                <a
                  ...
                  className="text-gray-600 dark:text-gray-400 hover:text-emerald-600 dark:hover:text-cyan-400 transition-colors text-sm inline-flex items-center gap-2 group"
                >
                  <ChatBubbleLeftRightIcon className="w-4 h-4 group-hover:text-emerald-600 dark:group-hover:text-cyan-400" />
                  Contact Us
                </a>
              </li>
            </ul>
            ...
            <div className="flex items-center gap-2">
              {navigation.allthrive.map((item) => (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-8 h-8 rounded-sm bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10 flex items-center justify-center text-gray-500 dark:text-gray-400 hover:text-emerald-600 dark:hover:text-cyan-400 hover:border-emerald-500/30 dark:hover:border-cyan-500/30 transition-all duration-300"
        ...
        <div className="mt-10 pt-8 border-t border-gray-200 dark:border-white/5 flex flex-col lg:flex-row items-center justify-between gap-4">
          <p className="text-gray-500 text-sm flex flex-wrap items-center justify-center lg:justify-start gap-x-1">
            ...
            <Link to="/privacy" className="hover:text-emerald-600 dark:hover:text-cyan-400 transition-colors">
              Privacy Policy
            </Link>
            <span className="mx-2">·</span>
            <Link to="/terms" className="hover:text-emerald-600 dark:hover:text-cyan-400 transition-colors">
              Terms of Service
            </Link>
          </p>
