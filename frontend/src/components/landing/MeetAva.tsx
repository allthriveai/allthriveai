/**
 * MeetAva - Scroll-snap experience showing 3 scenarios (Learn, Share, Play)
...
type MessageType = 'user' | 'ava' | 'projects' | 'game' | 'cta' | 'share-cta' | 'url-input' | 'project-preview';

interface ChatMessage {
  type: MessageType;
  text?: string;
  showAvatar?: boolean; // Force show Ava avatar on this message
}
...
const scenarios: Scenario[] = [
  ...
  },
  {
    id: 'share',
    title: 'Share',
    description: 'Let Ava create your project post',
    icon: ShareIcon,
    accentColor: 'purple',
    messages: [
      {
        ...
        if (message.type === 'ava') {
          ...
          return (
            <motion.div
              ...
              transition={{ duration: 0.3, delay: index * 0.1 }}
            >
              <ChatBubble type="ava" showAvatar={shouldShowAvatar}>
                <p className="text-sm">{message.text}</p>
              </ChatBubble>
            </motion.div>
          );
...
// Sticky Ava chat panel
function AvaChatPanel({ activeScenario }: { activeScenario: ScenarioId }) {
  ...
  return (
    <div className="h-full flex flex-col glass-card rounded border border-white/10 overflow-hidden">
      ...
      <div className="flex items-center gap-3 px-5 py-4 border-b border-white/10 bg-white/5">
        ...
        />
        <div>
          <h3 className="text-white font-semibold">Ava</h3>
    ...
    <section className="relative overflow-hidden">
      ...
      <div className="hidden lg:block relative z-10 h-[300vh]">
        <div className="sticky top-0 h-screen flex">
          ...
          {/* Right: Sticky Ava chat */}
          <div className="w-[420px] xl:w-[480px] h-screen p-6 pl-0">
            <AvaChatPanel activeScenario={activeScenario} />
          </div>
