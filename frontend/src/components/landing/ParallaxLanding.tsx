        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-xl text-gray-400 mb-6">
              Ask Ava anything. Get curated projects from the community and personalized learning paths.
            </p>
            <div className="glass-card rounded-xl p-4 border border-white/10">
              <div className="flex items-start gap-3 mb-4">
                <img src="/ava-avatar.png" alt="Ava" className="w-10 h-10 rounded-full border-2 border-cyan-500/50" />
                <div className="flex-1">
                  <p className="text-white font-medium">Ava</p>
      ...
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-xl text-gray-400 mb-6">
              Paste a URL or upload an image. Ava creates your project post automatically.
            </p>
