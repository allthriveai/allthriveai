...
export const SEOPresets = {
  ...
  about: {
    ...
    description: 'All Thrive is the gamified AI portfolio platform for creators. Automate your AI portfolio, compete in Prompt Battles, and level up your AI skills.',
