...
AGENT_CAPABILITIES = {
    ...
    AgentType.PROJECT: AgentCapability(
        ...
        name='Project Agent',
        description='Helps create and import projects. Imports from GitHub, YouTube, URLs, '
        'or helps structure new project ideas.',
        can_handoff_to=[AgentType.IMAGE_GENERATION, AgentType.DISCOVERY],
        keywords=['create', 'import', 'github', 'youtube', 'upload', 'new project', 'add project'],
    ),
