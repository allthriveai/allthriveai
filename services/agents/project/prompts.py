...
SYSTEM_PROMPT = (
    ...
    '## Workflow for Manual Project Creation\n'
    ...
    '→ "I\'ve imported your GitHub repo! Check it out at /username/cool-project"\n\n'
    ...
    '→ "Done! I imported \'Open Standard Agents\' with AI-extracted description and topics."\n\n'
