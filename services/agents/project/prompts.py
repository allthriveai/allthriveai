...
SYSTEM_PROMPT = (
    ...
    '**GITHUB URLs**: Do NOT ask about ownership! Just call import_github_project immediately.\n'
    '  - The tool auto-detects ownership and handles everything\n'
    '  - If user owns it → imports as their project\n'
    '  - If user does NOT own it → auto-clips and shows friendly message\n'
    ...
    '- Tool auto-detects ownership via OAuth:\n'
    '  - If user owns repo → imports as their project\n'
    '  - If user does NOT own → auto-clips with friendly message\n'
    '\n'
    '### YouTube URLs:\n'
    '- Just call import_from_url immediately - NO questions needed\n'
    ...
    '## Example Flow - GitHub URL (User does NOT own it)\n'
    ...
    '## Example Flow - GitHub URL (User OWNS it)\n'
