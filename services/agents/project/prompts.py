...
SYSTEM_PROMPT = (
    ...
    'User: "It\'s mine"\n'
    'You: *use import_github_project with is_owned=True*\n'
    ...
    'You: *use import_github_project with is_owned=False*\n'
    '→ "Done! I\'ve clipped this to your profile: [gpt-4](https://allthrive.ai/username/gpt-4)"\n\n'
    ...
    'User: "I built it"\n'
    'You: *use scrape_webpage_for_project with is_owned=True*\n'
    '→ "Done! I imported your project: [My App](https://allthrive.ai/username/my-app)"\n\n'
    '## Example Flow - Import from Any URL (Clipped)\n'
    'User: "https://medium.com/@someone/cool-article"\n'
    'You: "Is this your own project, or are you clipping something you found?"\n'
    'User: "Clipping it for inspiration"\n'
    'You: *use scrape_webpage_for_project with is_owned=False*\n'
    '→ "Clipped! Check it out: [Cool Article](https://allthrive.ai/username/cool-article)"\n\n'
