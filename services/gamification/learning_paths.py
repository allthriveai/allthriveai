...
QUIZ_TOPIC_TO_PATH_TOPIC = {
    ...
    'prompt engineering': 'prompts-templates',
    'chain-of-thought': 'prompts-templates',
    'few-shot learning': 'prompts-templates',
    ...
    'ai frameworks': 'ai-agents-multitool',
    'autogen': 'ai-agents-multitool',
    'crewai': 'ai-agents-multitool',
    'langchain': 'ai-agents-multitool',
    'langgraph': 'ai-agents-multitool',
    'multi-agent systems': 'ai-agents-multitool',
    'ai-models': 'ai-models-research',
    'research': 'ai-models-research',
    'ai-models-research': 'ai-models-research',
    'llm': 'ai-models-research',
    'ai best practices': 'ai-models-research',
    'data': 'data-analytics',
